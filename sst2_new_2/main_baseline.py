...
logger = get_logger(log_file=f"baseline_{args.dataset}_seed_{args.seed}_{datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')}.txt")
...
if __name__ == "__main__":
    ...
    model_save_name = f"baseline_{args.dataset}_seed_{args.seed}_model.pkl"
