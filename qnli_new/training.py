...
class Trainer:
    ...
    def predict(self,data_loader):
        self.model.load_state_dict(torch.load(
            f'{args.save_path}/{args.embedding_type}_{args.mapping_strategy}_'
            f'{args.privatization_strategy}_eps_{args.eps}_top_{args.top_k}_'
            f'save_{args.save_stop_words}_seed_{args.seed}_model.pkl'
        ))
        self.model.eval()
        y_list = []
        y_hat_list = []
