...
glove_path = os.path.join(base_dir, "glove_840B-300d.txt")
output_path = os.path.join(base_dir, "glove_filtered.txt")

# Step 1: 读取 ct_vectors.txt 中的所有词
...
# Step 2: 遍历 glove 文件，只保留在 ct_words 中的行
